...
TEST_CASE("Find kth") {
    ...
    REQUIRE(FindKthToLast(head.get(), 3)->Value == 3);
    REQUIRE(FindKthToLast(head.get(), 2)->Value == 5);
    REQUIRE(FindKthToLast(head.get(), 1)->Value == 4);
    REQUIRE(FindKthToLast(head.get(), 8)->Value == 1);
}
